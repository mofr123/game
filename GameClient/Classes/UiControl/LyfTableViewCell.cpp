...
void LyfTableViewCell::onEnter()
{
	...
	listener->onTouchCancelled = CC_CALLBACK_2(LyfTableViewCell ::onTouchCancelled, this );
...
void LyfTableViewCell::setTextLabel(Label* textLabel)
{
...
Label* LyfTableViewCell::getTextLabel()
{
    
    return m_textLabel;
}

void LyfTableViewCell::setDetailTextLabel(Label* detailTextLabel)
{
...
Label* LyfTableViewCell::getDetailTextLabel()
{
...
void LyfTableViewCell::delShowAction(float dt)
{
    float width=((Node*)m_delBtn->getChildren().at(0))->getPositionX();//objectAtIndex(0)
...
void LyfTableViewCell::delHideAction(float dt)
{
...
void LyfTableViewCell::removeThis(float dt){
