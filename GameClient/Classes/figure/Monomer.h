#ifndef __mir_mobile__Monomer__
#define __mir_mobile__Monomer__
...
public:
	...
	Point getHandPointRelativeFootOffset();

	Point getHandPoint();

	Point getHurtPointRelativeFootOffset();
	...
	int getAlphaWithPoint(Point point);
...
protected:
	...
	Vector<FiniteTimeAction*> actionsWithPoint(MapPoint& pStart, MapPoint& pFinish);

	Vector<FiniteTimeAction*> actionsWithMoveTo(std::deque<MapPoint>& pArray);
