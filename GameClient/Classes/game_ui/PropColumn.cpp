...
bool PropColumnMenu::init()
{
    ...
    m_propColumn = LayerColor::create(Color4B(255, 255, 255, 0), GRID_WIDTH*COL, GRID_HEIGHT*ROW);
    ...
    button->addTargetWithActionForControlEvents(GAME_UILAYER, cccontrol_selector(
		GameInfoUIController::removeSmallMenuAndButton), Control::EventType::TOUCH_UP_INSIDE);
